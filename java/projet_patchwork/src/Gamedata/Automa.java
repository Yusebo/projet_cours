...
/**Class linked at Automa
 * */
public non-sealed class Automa implements Player_automa{
  private final ArrayList<Patch> automa_patch;
  ...
  public Automa() {
    ...
    this.position = 0;
    this.button = 5;
    this.automa_patch = new ArrayList<Patch>();
  ...
  /**Add patch in the patch list
   * */
  public void add_patch(Patch patch) {
    this.automa_patch.add(patch);
  }
  
  /**automa doen't have quilt board
   * @return because automa doen't have quilt board
   * */
